...
{<img src="https://travis-ci.org/kiv-redmine/redmine_wiki_extensions.svg?branch=testing" alt="Build Status" />}[https://travis-ci.org/kiv-redmine/redmine_wiki_extensions]
